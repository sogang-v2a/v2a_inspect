...
class HunyuanGenerateV2ARequest(BaseModel):
    ...
    start_frame_index: int = Field(..., description="Start frame index for audio generation")
    end_frame_index: int = Field(..., description="End frame index for audio generation")
